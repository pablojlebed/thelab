...
{#if show && task}
    ...
    >
        ...
        <div
            class="relative w-full max-w-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-2xl overflow-hidden animate-fade-in-up max-h-[80vh] flex flex-col"
        >
            <!-- Header -->
            <div class="p-6 border-b border-slate-100 dark:border-slate-700">
                ...
                <div
                    class="mt-4 flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400"
                >
                    <span
                        >Owner: <strong
            ...
            <!-- Comments Section -->
            <div
                class="flex-1 overflow-y-auto p-6 bg-slate-50/50 dark:bg-slate-900/30"
            >
                ...
                {:else}
                    <div class="space-y-3">
                        {#each comments as comment}
                            <div
                                class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg p-3 shadow-sm"
                            >
                                <p
            ...
            <!-- Add Comment -->
            <div
                class="p-4 border-t border-slate-100 dark:border-slate-700 bg-white dark:bg-slate-800"
            >
                <div class="flex gap-2">
                    <input
                        bind:value={newComment}
                        placeholder="Add a comment..."
                        class="flex-1 px-4 py-2 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg text-sm text-slate-800 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
